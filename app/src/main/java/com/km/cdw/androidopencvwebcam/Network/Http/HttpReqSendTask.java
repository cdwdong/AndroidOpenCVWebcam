...
public class HttpReqSendTask implements Runnable {
    ...
    private static final String DEFAULT_BASE_URL = "http://192.168.10.100:3000/";
    ...
    private HttpReqSendTask(Context context, String baseUrl, SettingService settingService, int reqType, GsonSettingType data) {
        mContext = context;
        mBaseUrl = baseUrl;
    ...
    public static class Builder {
        ...
        public Builder() {
            Retrofit retrofit = new Retrofit.Builder().baseUrl(DEFAULT_BASE_URL)
        ...
        public HttpReqSendTask build() {
            ...
            return new HttpReqSendTask(mContext, mBaseUrl, mSettingService,mReqType,mReqData);
        }
